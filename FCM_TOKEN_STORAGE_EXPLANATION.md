...
│         DEVICE (Frontend)                │
│                                          │
│  1. Firebase SDK generates token         │
│     messaging().getToken()               │
│                                          │
...
│     (Permanently stored)                 │
│                                          │
│  6. Use token to send notifications      │
...
### Frontend (App)
- ✅ Token is generated on device
- ✅ Token is stored in React state (memory)
- ✅ Token is sent to backend
- ❌ Token is NOT stored in Realm/local DB
- ❌ Token is NOT persisted across app restarts (Firebase handles this)

### Backend (Server)
- ✅ Token is received from app
- ✅ Token is stored in database (User table)
- ✅ Token is used to send notifications
